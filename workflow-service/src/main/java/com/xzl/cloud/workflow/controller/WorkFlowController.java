...
import com.xzl.cloud.workflow.utils.RequestQuery;
...
public class WorkFlowController {
    ...
    public ResultResponse startProcessInstance(@RequestBody RequestQuery query) throws IOException {
        Map map = query.getUserSetup().toMap();
        commonService.startProcess(map, query.getProcKey());
    ...
    public ResultResponse complete(@RequestBody RequestQuery query) {
